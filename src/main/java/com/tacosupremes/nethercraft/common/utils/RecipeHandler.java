...
public final class RecipeHandler
{
	...
	public static void addShapelessRecipe(ItemStack output, Object... inputs)
	{
		...
		if(!Nethercraft.config.isItemEnabled(output.getItem()))		
			return;		
	...
	public static void addShapedRecipe(ItemStack output, Object... inputs)
	{
		...
		{
			if(!Nethercraft.config.isBlockEnabled(Block.getBlockFromItem(output.getItem())))		
					return;
		}
		else if(!Nethercraft.config.isItemEnabled(output.getItem()))		
			return;
