package com.tacosupremes.nethercraft.common.lib;
...
public class LibMisc
{
	...
	public static final String COMMONPROXY = "com.tacosupremes.nethercraft.proxy.CommonProxy";
	public static final String CLIENTPROXY = "com.tacosupremes.nethercraft.proxy.ClientProxy";
	...
	public static class Ores
	{
		...
		public static void preInit()
		{
			...
			addOre("oreCopper", Color.orange); // IC2, Thermal Expansion,
												// Tinkers' Construct, etc.
			addOre("oreDark", Color.BLACK); // EvilCraft
			addOre("oreDarkIron", Color.black); // Factorization (older
												// versions)
			addOre("oreFzDarkIron", Color.black); // Factorization (newer
													// versions)
			...
			addOre("oreLead", Color.DARK_GRAY); // IC2, Thermal Expansion,
												// Factorization, etc.
			...
			addOre("oreSilver", Color.LIGHT_GRAY); // Thermal Expansion,
													// Factorization, etc.
	...
	{
		private static Map<Integer, Entity> l = new HashMap<Integer, Entity>();
		
		
		public static void randNetherEnemy(){};
